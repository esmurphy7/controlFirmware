...
void Interface::init() {
  ...
  // Loop until this Arduino has recieved an id
  while(!_id){
    if(Serial2.available()){
      // Recieved a 2 byte serial command
...
// Send Serial data towards the head of the snake
void Interface::sendUp() {
  Serial2.write(_id);
  Serial2.write(STATE_ALIVE);
}

// Send Serial data towards the tail of the snake
